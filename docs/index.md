...
An example of a repository generated with this package can be found [here](https://github.com/joeblackwaslike/cookiecutter-ds-example).
...
cookiecutter https://github.com/joeblackwaslike/cookiecutter-ds.git
```
